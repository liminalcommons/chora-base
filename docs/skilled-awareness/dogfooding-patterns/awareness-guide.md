...
**Agent Workflow**:
1. When using SAP-027, check if SAP-000 is installed
...
**Relationship**: [How this SAP depends on SAP-029]

**Agent Workflow**:
1. When using SAP-027, check if SAP-029 is installed
2. If not, recommend installing SAP-029 first
3. [Additional integration steps]
