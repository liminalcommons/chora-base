...
# React File Upload & Storage (SAP-035) - Agent Awareness
...
The README provides:
- 🚀 **Quick Start** - 20-30 minutes setup with production-ready patterns
- 📚 **Time Savings** - 91.7% (6 hours → 30 minutes) reduction in implementation time
...
This AGENTS.md provides: Agent-specific patterns for implementing react file upload & storage in React/Next.js applications.
...
**Use SAP-035 React File Upload & Storage when**:
- Building React/Next.js applications requiring file upload & storage
...
- Project doesn't require file upload & storage
...
**Context**: Agent needs to set up react file upload & storage in a Next.js 15 project
...
- **[SAP-036 (Error Handling)](../react-error-handling/)** - Integration point
...
- **1.0.0** (2025-11-09): Initial release
  ...
  - TypeScript support
  - 91.7% (6 hours → 30 minutes) time savings validation
