# Protocol Specification: Publishing Automation
...
Secure PyPI publishing with OIDC trusted publishing as default, eliminating long-lived API tokens for chora-base generated projects
...
#### Integration with SAP-003

<!-- TODO: Describe how this SAP integrates with SAP-003 -->

**Integration Point**: [Description]

**Configuration**:
```yaml
# Example configuration for SAP-003 integration
```


#### Integration with SAP-005

<!-- TODO: Describe how this SAP integrates with SAP-005 -->

**Integration Point**: [Description]

**Configuration**:
```yaml
# Example configuration for SAP-005 integration
```
...
|----------|----------|---------|-------------|
| `PUBLISHING-AUTOMATION_ENABLED` | No | `true` | Enable/disable this capability |
...
|------|-------|-------|------------|
| `SAP-028-001` | [Error name] | [Common cause] | [How to fix] |
| `SAP-028-002` | [Error name] | [Common cause] | [How to fix] |
...
<!-- TODO: Define security model for this capability -->
...
```bash
# Quick validation - Verify SAP-028 artifacts present
...
# Validate OIDC publishing configuration
cat .github/workflows/release.yml | grep "id-token: write"
# Expected: Should find id-token permission for OIDC

# Test publish to TestPyPI (dry run)
gh workflow run release.yml --ref main -f environment=test

# Verify PEP 740 attestations are enabled
gh api repos/{owner}/{repo}/actions/permissions | jq '.attestations_enabled'
# Expected: true

# Check PyPI trusted publisher configuration
# Visit: https://pypi.org/manage/account/publishing/
# Verify: Repository listed with OIDC trust relationship
```
...
| SAP-003 | 1.0.0 | Latest | ✅ Compatible |

| SAP-005 | 1.0.0 | Latest | ✅ Compatible |
...
- [SAP-003](../[directory]/protocol-spec.md) - [Description of relationship]

- [SAP-005](../[directory]/protocol-spec.md) - [Description of relationship]
...
**Version History**:
- **1.0.0** (2025-11-02): Initial protocol specification for Publishing Automation