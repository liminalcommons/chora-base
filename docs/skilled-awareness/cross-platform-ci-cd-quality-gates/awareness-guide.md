# Awareness Guide: Cross-Platform CI/CD & Quality Gates
...
SAP-032 establishes multi-OS CI/CD as standard quality gate (ubuntu/macos/windows matrix) to catch 15-20% more platform-specific bugs pre-release and prevent chora-compose-style rework.
...
```
User request about Cross-Platform CI/CD & Quality Gates
   │
   ├─ [Condition 1]?
...
**Agent Workflow**:
1. When using SAP-032, check if SAP-000 is installed
...
**Agent Workflow**:
1. When using SAP-032, check if SAP-005 is installed
...
**Agent Workflow**:
1. When using SAP-032, check if SAP-030 is installed
...
### Explaining Cross-Platform CI/CD & Quality Gates to Users
...
Before completing a task with SAP-032, agents should verify:
...
- **SAP-032 1.0.0** is compatible with:
