# Adoption Blueprint: Example Capability for Pilot
...
This blueprint provides step-by-step instructions for adopting SAP-029 Example Capability for Pilot across three progressive levels.
...
- Getting started with Example Capability for Pilot
...
**Version History**:
- **1.0.0** (2025-11-10): Initial adoption blueprint for Example Capability for Pilot