# Protocol Specification: Example Capability for Pilot
...
Example SAP to test generation workflow and validate dogfooding pilot
...
- MVP field integration

- Automatic structure creation

- Placeholder guidance for manual content
...
|----------|----------|---------|-------------|
| `EXAMPLE-CAPABILITY_ENABLED` | No | `true` | Enable/disable this capability |
...
```bash
# Validate Example Capability for Pilot is correctly configured
...
**Version History**:
- **1.0.0** (2025-11-10): Initial protocol specification for Example Capability for Pilot