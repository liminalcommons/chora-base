# Awareness Guide: Example Capability for Pilot
...
SAP-029 defines template-based SAP artifact generation to reduce creation time from 10 hours to 2 hours (80% savings).
...
```
User request about Example Capability for Pilot
   │
   ├─ [Condition 1]?
...
**Agent Workflow**:
1. When using SAP-029, check if SAP-000 is installed
...
### Explaining Example Capability for Pilot to Users
