...
echo "  2. Find the 'example-mcp-vision-dev' section"
echo "  3. Comment it out or remove it completely"
echo "  4. Enable 'example-mcp-vision-stable' or 'example-mcp-vision' section"
...
if ./scripts/verify-stable.sh; then
    ...
    echo "  - example-mcp-vision package not installed (run: pip install example-mcp-vision)"
