#!/usr/bin/env bash
# setup.sh - One-command project setup for test-docs-standard
#
# Usage: ./scripts/setup.sh

set -euo pipefail

echo "=== test-docs-standard Setup Script ==="
echo ""
...
if command -v just &> /dev/null; then
    ...
    ruff check src/test_docs_standard tests || true
    echo ""
    echo "Running type checking..."
    mypy src/test_docs_standard || true
fi
