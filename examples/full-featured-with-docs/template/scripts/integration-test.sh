...
#
# This script validates that test-docs-standard can parse events emitted by chora-composer.
...
echo "  2. test-docs-standard can parse event schema"
...
echo "  2. Update test-docs-standard dependency"
