...
echo "  2. Find the 'test-docs-standard-dev' section"
echo "  3. Comment it out or remove it completely"
echo "  4. Enable 'test-docs-standard-stable' or 'test-docs-standard' section"
...
if ./scripts/verify-stable.sh; then
    ...
    echo "  - test-docs-standard package not installed (run: pip install test-docs-standard)"
