...
def gather_files_full(patterns, include_dotfiles=False):
    files = []
...
def parse_args():
    ...
    parser.add_argument(
        "--include-dotfiles",
        action="store_true",
        help="Include dot-files and dot-directories in the dump",
    )
...
def main():
    ...
    if args.mode == "full":
        ...
        files = gather_files_full(patterns, args.include_dotfiles)
    else:
