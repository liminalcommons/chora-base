...
#
# This script validates that example-mcp-vision can parse events emitted by chora-composer.
...
echo "  2. example-mcp-vision can parse event schema"
...
echo "  2. Update example-mcp-vision dependency"
