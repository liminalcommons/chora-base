...
#
# This script validates that {{ project_slug }} can parse events emitted by chora-composer.
...
echo "  2. {{ project_slug }} can parse event schema"
...
echo "  2. Update {{ project_slug }} dependency"
