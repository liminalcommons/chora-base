...
echo "  2. Find the '{{ project_slug }}-dev' section"
echo "  3. Comment it out or remove it completely"
echo "  4. Enable '{{ project_slug }}-stable' or '{{ project_slug }}' section"
...
if ./scripts/verify-stable.sh; then
    ...
    echo "  - {{ project_slug }} package not installed (run: pip install {{ project_slug }})"
