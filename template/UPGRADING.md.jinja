...
- [ ] `src/{{ package_name }}/__init__.py` - Customization: [describe]
{% if include_memory_system -%}
- [ ] `src/{{ package_name }}/memory/__init__.py` - Customization: [describe]
- [ ] `src/{{ package_name }}/memory/trace.py` - Customization: [describe]
{% endif -%}
- [ ] Other: [file] - Customization: [describe]
...
```json
{
  "id": "{{ project_slug }}-upgrade-vOLD-to-vNEW",
  "created": "YYYY-MM-DD",
  "tags": ["{{ project_slug }}", "chora-base", "upgrade"],
