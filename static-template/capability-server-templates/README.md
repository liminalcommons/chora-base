...
│   └── mcp/                      # FastMCP interface (optional)
│       ├── __init__.py           # MCP server setup
│       ├── tools.py              # MCP tools
│       └── resources.py          # MCP resources
├── infrastructure/                # ✅ Phase 3 Complete
│   ├── __init__.py               # Optional infrastructure exports
│   ├── registry/                 # Service discovery (SAP-044)
│   │   ├── __init__.py
│   │   └── registry.py           # ServiceRegistry implementation
│   ├── bootstrap/                # Startup orchestration (SAP-045)
│   │   ├── __init__.py
│   │   └── bootstrap.py          # Bootstrap orchestrator
│   └── composition/              # Saga, circuit breaker, events (SAP-046)
│       ├── __init__.py
│       ├── circuit_breaker.py    # Circuit breaker pattern
│       ├── event_bus.py          # Event-driven communication
│       └── saga.py               # Saga orchestration
├── config/                        # 🚧 Phase 4 (Planned)
│   └── settings.py               # Configuration management
└── tests/                         # ✅ Phase 3 Complete (Core + Interface + Infrastructure)
    ...
    │   └── test_mcp.py           # MCP tool tests (optional)
    └── infrastructure/           # ✅ Phase 3 Complete
        ├── test_registry.py      # Service registry tests
        ├── test_bootstrap.py     # Bootstrap orchestrator tests
...
## Phase 2: Interface Templates (✅ Complete)
...
### ✅ Phase 5: Script Integration (Complete)
...
- ✅ Generated code passes `ruff check` (linting)
